...
package STM32G431xx.I2C is
   ...
   subtype CR1_PE_Field is STM32G431xx.Bit;
   subtype CR1_TXIE_Field is STM32G431xx.Bit;
   subtype CR1_RXIE_Field is STM32G431xx.Bit;
   subtype CR1_ADDRIE_Field is STM32G431xx.Bit;
   subtype CR1_NACKIE_Field is STM32G431xx.Bit;
   subtype CR1_STOPIE_Field is STM32G431xx.Bit;
   subtype CR1_TCIE_Field is STM32G431xx.Bit;
   subtype CR1_ERRIE_Field is STM32G431xx.Bit;
   subtype CR1_DNF_Field is STM32G431xx.UInt4;
   subtype CR1_ANFOFF_Field is STM32G431xx.Bit;
   subtype CR1_TXDMAEN_Field is STM32G431xx.Bit;
   subtype CR1_RXDMAEN_Field is STM32G431xx.Bit;
   subtype CR1_SBC_Field is STM32G431xx.Bit;
   subtype CR1_NOSTRETCH_Field is STM32G431xx.Bit;
   subtype CR1_WUPEN_Field is STM32G431xx.Bit;
   subtype CR1_GCEN_Field is STM32G431xx.Bit;
   subtype CR1_SMBHEN_Field is STM32G431xx.Bit;
   subtype CR1_SMBDEN_Field is STM32G431xx.Bit;
   subtype CR1_ALERTEN_Field is STM32G431xx.Bit;
   subtype CR1_PECEN_Field is STM32G431xx.Bit;
   ...
   subtype CR2_SADD_Field is STM32G431xx.UInt10;
   subtype CR2_RD_WRN_Field is STM32G431xx.Bit;
   subtype CR2_ADD10_Field is STM32G431xx.Bit;
   subtype CR2_HEAD10R_Field is STM32G431xx.Bit;
   subtype CR2_START_Field is STM32G431xx.Bit;
   subtype CR2_STOP_Field is STM32G431xx.Bit;
   subtype CR2_NACK_Field is STM32G431xx.Bit;
   subtype CR2_NBYTES_Field is STM32G431xx.Byte;
   subtype CR2_RELOAD_Field is STM32G431xx.Bit;
   subtype CR2_AUTOEND_Field is STM32G431xx.Bit;
   subtype CR2_PECBYTE_Field is STM32G431xx.Bit;
   ...
   subtype OAR1_OA1_Field is STM32G431xx.UInt10;
   subtype OAR1_OA1MODE_Field is STM32G431xx.Bit;
   subtype OAR1_OA1EN_Field is STM32G431xx.Bit;
   ...
   subtype OAR2_OA2_Field is STM32G431xx.UInt7;
   subtype OAR2_OA2MSK_Field is STM32G431xx.UInt3;
   subtype OAR2_OA2EN_Field is STM32G431xx.Bit;
   ...
   subtype TIMINGR_SCLL_Field is STM32G431xx.Byte;
   subtype TIMINGR_SCLH_Field is STM32G431xx.Byte;
   subtype TIMINGR_SDADEL_Field is STM32G431xx.UInt4;
   subtype TIMINGR_SCLDEL_Field is STM32G431xx.UInt4;
   subtype TIMINGR_PRESC_Field is STM32G431xx.UInt4;
   ...
   type TIMINGR_Register is record
      ...
      --  unspecified
      Reserved_24_27 : STM32G431xx.UInt4 := 16#0#;
      --  Timing prescaler
   ...
   subtype TIMEOUTR_TIMEOUTA_Field is STM32G431xx.UInt12;
   subtype TIMEOUTR_TIDLE_Field is STM32G431xx.Bit;
   subtype TIMEOUTR_TIMOUTEN_Field is STM32G431xx.Bit;
   subtype TIMEOUTR_TIMEOUTB_Field is STM32G431xx.UInt12;
   subtype TIMEOUTR_TEXTEN_Field is STM32G431xx.Bit;
   ...
   subtype ISR_TXIS_Field is STM32G431xx.Bit;
   subtype ISR_RXNE_Field is STM32G431xx.Bit;
   subtype ISR_ADDR_Field is STM32G431xx.Bit;
   subtype ISR_NACKF_Field is STM32G431xx.Bit;
   subtype ISR_STOPF_Field is STM32G431xx.Bit;
   subtype ISR_TC_Field is STM32G431xx.Bit;
   subtype ISR_TCR_Field is STM32G431xx.Bit;
   subtype ISR_BERR_Field is STM32G431xx.Bit;
   subtype ISR_ARLO_Field is STM32G431xx.Bit;
   subtype ISR_OVR_Field is STM32G431xx.Bit;
   subtype ISR_PECERR_Field is STM32G431xx.Bit;
   subtype ISR_TIMEOUT_Field is STM32G431xx.Bit;
   subtype ISR_ALERT_Field is STM32G431xx.Bit;
   subtype ISR_BUSY_Field is STM32G431xx.Bit;
   subtype ISR_DIR_Field is STM32G431xx.Bit;
   subtype ISR_ADDCODE_Field is STM32G431xx.UInt7;
   ...
   subtype ICR_ADDRCF_Field is STM32G431xx.Bit;
   subtype ICR_NACKCF_Field is STM32G431xx.Bit;
   subtype ICR_STOPCF_Field is STM32G431xx.Bit;
   subtype ICR_BERRCF_Field is STM32G431xx.Bit;
   subtype ICR_ARLOCF_Field is STM32G431xx.Bit;
   subtype ICR_OVRCF_Field is STM32G431xx.Bit;
   subtype ICR_PECCF_Field is STM32G431xx.Bit;
   subtype ICR_TIMOUTCF_Field is STM32G431xx.Bit;
   subtype ICR_ALERTCF_Field is STM32G431xx.Bit;
   ...
   subtype PECR_PEC_Field is STM32G431xx.Byte;
