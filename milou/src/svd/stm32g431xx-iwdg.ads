...
package STM32G431xx.IWDG is
   ...
   subtype KR_KEY_Field is STM32G431xx.UInt16;
   ...
   subtype PR_PR_Field is STM32G431xx.UInt3;
   ...
   type PR_Register is record
      ...
      PR            : PR_PR_Field := 16#0#;
      --  unspecified
      Reserved_3_31 : STM32G431xx.UInt29 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype RLR_RL_Field is STM32G431xx.UInt12;
   ...
   subtype SR_PVU_Field is STM32G431xx.Bit;
   subtype SR_RVU_Field is STM32G431xx.Bit;
   subtype SR_WVU_Field is STM32G431xx.Bit;
   ...
   subtype WINR_WIN_Field is STM32G431xx.UInt12;
