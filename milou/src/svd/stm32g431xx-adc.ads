...
package STM32G431xx.ADC is
   ...
   subtype ISR_ADRDY_Field is STM32G431xx.Bit;
   subtype ISR_EOSMP_Field is STM32G431xx.Bit;
   subtype ISR_EOC_Field is STM32G431xx.Bit;
   subtype ISR_EOS_Field is STM32G431xx.Bit;
   subtype ISR_OVR_Field is STM32G431xx.Bit;
   subtype ISR_JEOC_Field is STM32G431xx.Bit;
   subtype ISR_JEOS_Field is STM32G431xx.Bit;
   --  ISR_AWD array element
   subtype ISR_AWD_Element is STM32G431xx.Bit;
   ...
   subtype ISR_JQOVF_Field is STM32G431xx.Bit;
   ...
   subtype IER_ADRDYIE_Field is STM32G431xx.Bit;
   subtype IER_EOSMPIE_Field is STM32G431xx.Bit;
   subtype IER_EOCIE_Field is STM32G431xx.Bit;
   subtype IER_EOSIE_Field is STM32G431xx.Bit;
   subtype IER_OVRIE_Field is STM32G431xx.Bit;
   subtype IER_JEOCIE_Field is STM32G431xx.Bit;
   subtype IER_JEOSIE_Field is STM32G431xx.Bit;
   subtype IER_AWD1IE_Field is STM32G431xx.Bit;
   subtype IER_AWD2IE_Field is STM32G431xx.Bit;
   subtype IER_AWD3IE_Field is STM32G431xx.Bit;
   subtype IER_JQOVFIE_Field is STM32G431xx.Bit;
   ...
   subtype CR_ADEN_Field is STM32G431xx.Bit;
   subtype CR_ADDIS_Field is STM32G431xx.Bit;
   subtype CR_ADSTART_Field is STM32G431xx.Bit;
   subtype CR_JADSTART_Field is STM32G431xx.Bit;
   subtype CR_ADSTP_Field is STM32G431xx.Bit;
   subtype CR_JADSTP_Field is STM32G431xx.Bit;
   subtype CR_ADVREGEN_Field is STM32G431xx.Bit;
   subtype CR_DEEPPWD_Field is STM32G431xx.Bit;
   subtype CR_ADCALDIF_Field is STM32G431xx.Bit;
   subtype CR_ADCAL_Field is STM32G431xx.Bit;
   ...
   type CR_Register is record
      ...
      --  unspecified
      Reserved_6_27 : STM32G431xx.UInt22 := 16#0#;
      --  ADVREGEN
   ...
   subtype CFGR_DMAEN_Field is STM32G431xx.Bit;
   subtype CFGR_DMACFG_Field is STM32G431xx.Bit;
   subtype CFGR_RES_Field is STM32G431xx.UInt2;
   subtype CFGR_ALIGN_5_Field is STM32G431xx.Bit;
   subtype CFGR_EXTSEL_Field is STM32G431xx.UInt4;
   subtype CFGR_EXTEN_Field is STM32G431xx.UInt2;
   subtype CFGR_OVRMOD_Field is STM32G431xx.Bit;
   subtype CFGR_CONT_Field is STM32G431xx.Bit;
   subtype CFGR_AUTDLY_Field is STM32G431xx.Bit;
   subtype CFGR_ALIGN_Field is STM32G431xx.Bit;
   subtype CFGR_DISCEN_Field is STM32G431xx.Bit;
   subtype CFGR_DISCNUM_Field is STM32G431xx.UInt3;
   subtype CFGR_JDISCEN_Field is STM32G431xx.Bit;
   subtype CFGR_JQM_Field is STM32G431xx.Bit;
   subtype CFGR_AWD1SGL_Field is STM32G431xx.Bit;
   subtype CFGR_AWD1EN_Field is STM32G431xx.Bit;
   subtype CFGR_JAWD1EN_Field is STM32G431xx.Bit;
   subtype CFGR_JAUTO_Field is STM32G431xx.Bit;
   subtype CFGR_AWDCH1CH_Field is STM32G431xx.UInt5;
   subtype CFGR_JQDIS_Field is STM32G431xx.Bit;
   ...
   subtype CFGR2_ROVSE_Field is STM32G431xx.Bit;
   subtype CFGR2_JOVSE_Field is STM32G431xx.Bit;
   subtype CFGR2_OVSR_Field is STM32G431xx.UInt3;
   subtype CFGR2_OVSS_Field is STM32G431xx.UInt4;
   subtype CFGR2_TROVS_Field is STM32G431xx.Bit;
   subtype CFGR2_ROVSM_Field is STM32G431xx.Bit;
   subtype CFGR2_GCOMP_Field is STM32G431xx.Bit;
   subtype CFGR2_SWTRIG_Field is STM32G431xx.Bit;
   subtype CFGR2_BULB_Field is STM32G431xx.Bit;
   subtype CFGR2_SMPTRIG_Field is STM32G431xx.Bit;
   ...
   type CFGR2_Register is record
      ...
      --  unspecified
      Reserved_17_24 : STM32G431xx.Byte := 16#0#;
      --  SWTRIG
   ...
   subtype SMPR1_SMP_Element is STM32G431xx.UInt3;
   ...
   subtype SMPR1_SMPPLUS_Field is STM32G431xx.Bit;
   ...
   type SMPR1_Register is record
      ...
      --  unspecified
      Reserved_30_30 : STM32G431xx.Bit := 16#0#;
   ...
   subtype SMPR2_SMP_Element is STM32G431xx.UInt3;
   ...
   subtype TR1_LT1_Field is STM32G431xx.UInt12;
   subtype TR1_AWDFILT_Field is STM32G431xx.UInt3;
   subtype TR1_HT1_Field is STM32G431xx.UInt12;
   ...
   subtype TR2_LT2_Field is STM32G431xx.Byte;
   subtype TR2_HT2_Field is STM32G431xx.Byte;
   ...
   subtype TR3_LT3_Field is STM32G431xx.Byte;
   subtype TR3_HT3_Field is STM32G431xx.Byte;
   ...
   subtype SQR1_L_Field is STM32G431xx.UInt4;
   subtype SQR1_SQ1_Field is STM32G431xx.UInt5;
   subtype SQR1_SQ2_Field is STM32G431xx.UInt5;
   subtype SQR1_SQ3_Field is STM32G431xx.UInt5;
   subtype SQR1_SQ4_Field is STM32G431xx.UInt5;
   ...
   type SQR1_Register is record
      ...
      L              : SQR1_L_Field := 16#0#;
      --  unspecified
      Reserved_4_5   : STM32G431xx.UInt2 := 16#0#;
      --  SQ1
      SQ1            : SQR1_SQ1_Field := 16#0#;
      --  unspecified
      Reserved_11_11 : STM32G431xx.Bit := 16#0#;
      --  SQ2
   ...
   subtype SQR2_SQ5_Field is STM32G431xx.UInt5;
   subtype SQR2_SQ6_Field is STM32G431xx.UInt5;
   subtype SQR2_SQ7_Field is STM32G431xx.UInt5;
   subtype SQR2_SQ8_Field is STM32G431xx.UInt5;
   subtype SQR2_SQ9_Field is STM32G431xx.UInt5;
   ...
   type SQR2_Register is record
      ...
      --  unspecified
      Reserved_5_5   : STM32G431xx.Bit := 16#0#;
      --  SQ6
   ...
   subtype SQR3_SQ10_Field is STM32G431xx.UInt5;
   subtype SQR3_SQ11_Field is STM32G431xx.UInt5;
   subtype SQR3_SQ12_Field is STM32G431xx.UInt5;
   subtype SQR3_SQ13_Field is STM32G431xx.UInt5;
   subtype SQR3_SQ14_Field is STM32G431xx.UInt5;
   ...
   subtype SQR4_SQ15_Field is STM32G431xx.UInt5;
   subtype SQR4_SQ16_Field is STM32G431xx.UInt5;
   ...
   subtype DR_RDATA_Field is STM32G431xx.UInt16;
   ...
   subtype JSQR_JL_Field is STM32G431xx.UInt2;
   subtype JSQR_JEXTSEL_Field is STM32G431xx.UInt5;
   subtype JSQR_JEXTEN_Field is STM32G431xx.UInt2;
   subtype JSQR_JSQ1_Field is STM32G431xx.UInt5;
   subtype JSQR_JSQ2_Field is STM32G431xx.UInt5;
   subtype JSQR_JSQ3_Field is STM32G431xx.UInt5;
   subtype JSQR_JSQ4_Field is STM32G431xx.UInt5;
   ...
   type JSQR_Register is record
      ...
      --  unspecified
      Reserved_14_14 : STM32G431xx.Bit := 16#0#;
      --  JSQ2
      JSQ2           : JSQR_JSQ2_Field := 16#0#;
      --  unspecified
      Reserved_20_20 : STM32G431xx.Bit := 16#0#;
      --  JSQ3
      JSQ3           : JSQR_JSQ3_Field := 16#0#;
      --  unspecified
      Reserved_26_26 : STM32G431xx.Bit := 16#0#;
      --  JSQ4
   ...
   subtype OFR_OFFSET1_Field is STM32G431xx.UInt12;
   subtype OFR_OFFSETPOS_Field is STM32G431xx.Bit;
   subtype OFR_SATEN_Field is STM32G431xx.Bit;
   subtype OFR_OFFSET1_CH_Field is STM32G431xx.UInt5;
   subtype OFR_OFFSET1_EN_Field is STM32G431xx.Bit;
   ...
   type OFR_Register is record
      ...
      --  unspecified
      Reserved_12_23 : STM32G431xx.UInt12 := 16#0#;
      --  OFFSETPOS
   ...
   subtype JDR1_JDATA1_Field is STM32G431xx.UInt16;
   ...
   subtype JDR2_JDATA2_Field is STM32G431xx.UInt16;
   ...
   subtype JDR3_JDATA3_Field is STM32G431xx.UInt16;
   ...
   subtype JDR4_JDATA4_Field is STM32G431xx.UInt16;
   ...
   subtype AWD2CR_AWD2CH_Field is STM32G431xx.UInt19;
   ...
   subtype AWD3CR_AWD3CH_Field is STM32G431xx.UInt19;
   ...
   subtype DIFSEL_DIFSEL_0_Field is STM32G431xx.Bit;
   subtype DIFSEL_DIFSEL_1_18_Field is STM32G431xx.UInt18;
   ...
   subtype CALFACT_CALFACT_S_Field is STM32G431xx.UInt7;
   subtype CALFACT_CALFACT_D_Field is STM32G431xx.UInt7;
   ...
   subtype GCOMP_GCOMPCOEFF_Field is STM32G431xx.UInt14;
   ...
   subtype CSR_ADDRDY_MST_Field is STM32G431xx.Bit;
   subtype CSR_EOSMP_MST_Field is STM32G431xx.Bit;
   subtype CSR_EOC_MST_Field is STM32G431xx.Bit;
   subtype CSR_EOS_MST_Field is STM32G431xx.Bit;
   subtype CSR_OVR_MST_Field is STM32G431xx.Bit;
   subtype CSR_JEOC_MST_Field is STM32G431xx.Bit;
   subtype CSR_JEOS_MST_Field is STM32G431xx.Bit;
   subtype CSR_AWD1_MST_Field is STM32G431xx.Bit;
   subtype CSR_AWD2_MST_Field is STM32G431xx.Bit;
   subtype CSR_AWD3_MST_Field is STM32G431xx.Bit;
   subtype CSR_JQOVF_MST_Field is STM32G431xx.Bit;
   subtype CSR_ADRDY_SLV_Field is STM32G431xx.Bit;
   subtype CSR_EOSMP_SLV_Field is STM32G431xx.Bit;
   subtype CSR_EOC_SLV_Field is STM32G431xx.Bit;
   subtype CSR_EOS_SLV_Field is STM32G431xx.Bit;
   subtype CSR_OVR_SLV_Field is STM32G431xx.Bit;
   subtype CSR_JEOC_SLV_Field is STM32G431xx.Bit;
   subtype CSR_JEOS_SLV_Field is STM32G431xx.Bit;
   subtype CSR_AWD1_SLV_Field is STM32G431xx.Bit;
   subtype CSR_AWD2_SLV_Field is STM32G431xx.Bit;
   subtype CSR_AWD3_SLV_Field is STM32G431xx.Bit;
   subtype CSR_JQOVF_SLV_Field is STM32G431xx.Bit;
   ...
   type CSR_Register is record
      ...
      --  unspecified
      Reserved_11_15 : STM32G431xx.UInt5;
      --  Read-only. ADRDY_SLV
      ...
      --  unspecified
      Reserved_27_31 : STM32G431xx.UInt5;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CCR_DUAL_Field is STM32G431xx.UInt5;
   subtype CCR_DELAY_Field is STM32G431xx.UInt4;
   subtype CCR_DMACFG_Field is STM32G431xx.Bit;
   subtype CCR_MDMA_Field is STM32G431xx.UInt2;
   subtype CCR_CKMODE_Field is STM32G431xx.UInt2;
   subtype CCR_PRESC_Field is STM32G431xx.UInt4;
   subtype CCR_VREFEN_Field is STM32G431xx.Bit;
   subtype CCR_CH17SEL_Field is STM32G431xx.Bit;
   subtype CCR_CH18SEL_Field is STM32G431xx.Bit;
   ...
   type CCR_Register is record
      ...
      --  unspecified
      Reserved_12_12 : STM32G431xx.Bit := 16#0#;
   ...
   subtype CDR_RDATA_MST_Field is STM32G431xx.UInt16;
   subtype CDR_RDATA_SLV_Field is STM32G431xx.UInt16;
