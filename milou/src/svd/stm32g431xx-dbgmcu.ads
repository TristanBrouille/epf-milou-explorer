...
package STM32G431xx.DBGMCU is
   ...
   subtype IDCODE_DEV_ID_Field is STM32G431xx.UInt16;
   subtype IDCODE_REV_ID_Field is STM32G431xx.UInt16;
   ...
   subtype CR_DBG_SLEEP_Field is STM32G431xx.Bit;
   subtype CR_DBG_STOP_Field is STM32G431xx.Bit;
   subtype CR_DBG_STANDBY_Field is STM32G431xx.Bit;
   subtype CR_TRACE_IOEN_Field is STM32G431xx.Bit;
   subtype CR_TRACE_MODE_Field is STM32G431xx.UInt2;
   ...
   subtype APB1L_FZ_DBG_TIMER2_STOP_Field is STM32G431xx.Bit;
   subtype APB1L_FZ_DBG_TIM3_STOP_Field is STM32G431xx.Bit;
   subtype APB1L_FZ_DBG_TIM4_STOP_Field is STM32G431xx.Bit;
   subtype APB1L_FZ_DBG_TIM5_STOP_Field is STM32G431xx.Bit;
   subtype APB1L_FZ_DBG_TIMER6_STOP_Field is STM32G431xx.Bit;
   subtype APB1L_FZ_DBG_TIM7_STOP_Field is STM32G431xx.Bit;
   subtype APB1L_FZ_DBG_RTC_STOP_Field is STM32G431xx.Bit;
   subtype APB1L_FZ_DBG_WWDG_STOP_Field is STM32G431xx.Bit;
   subtype APB1L_FZ_DBG_IWDG_STOP_Field is STM32G431xx.Bit;
   subtype APB1L_FZ_DBG_I2C1_STOP_Field is STM32G431xx.Bit;
   subtype APB1L_FZ_DBG_I2C2_STOP_Field is STM32G431xx.Bit;
   subtype APB1L_FZ_DBG_I2C3_STOP_Field is STM32G431xx.Bit;
   subtype APB1L_FZ_DBG_LPTIMER_STOP_Field is STM32G431xx.Bit;
   ...
   type APB1L_FZ_Register is record
      ...
      --  unspecified
      Reserved_6_9     : STM32G431xx.UInt4 := 16#0#;
      ...
      --  unspecified
      Reserved_13_20   : STM32G431xx.Byte := 16#0#;
      ...
      --  unspecified
      Reserved_23_29   : STM32G431xx.UInt7 := 16#0#;
   ...
   subtype APB1H_FZ_DBG_I2C4_STOP_Field is STM32G431xx.Bit;
   ...
   subtype APB2_FZ_DBG_TIM1_STOP_Field is STM32G431xx.Bit;
   subtype APB2_FZ_DBG_TIM8_STOP_Field is STM32G431xx.Bit;
   subtype APB2_FZ_DBG_TIM15_STOP_Field is STM32G431xx.Bit;
   subtype APB2_FZ_DBG_TIM16_STOP_Field is STM32G431xx.Bit;
   subtype APB2_FZ_DBG_TIM17_STOP_Field is STM32G431xx.Bit;
   subtype APB2_FZ_DBG_TIM20_STOP_Field is STM32G431xx.Bit;
   subtype APB2_FZ_DBG_HRTIM0_STOP_Field is STM32G431xx.Bit;
   subtype APB2_FZ_DBG_HRTIM1_STOP_Field is STM32G431xx.Bit;
   subtype APB2_FZ_DBG_HRTIM2_STOP_Field is STM32G431xx.Bit;
   subtype APB2_FZ_DBG_HRTIM3_STOP_Field is STM32G431xx.Bit;
   ...
   type APB2_FZ_Register is record
      ...
      --  unspecified
      Reserved_21_25  : STM32G431xx.UInt5 := 16#0#;
      --  DBG_HRTIM0_STOP
