...
package STM32G431xx.SAI is
   ...
   subtype ACR1_MODE_Field is STM32G431xx.UInt2;
   subtype ACR1_PRTCFG_Field is STM32G431xx.UInt2;
   subtype ACR1_DS_Field is STM32G431xx.UInt3;
   subtype ACR1_LSBFIRST_Field is STM32G431xx.Bit;
   subtype ACR1_CKSTR_Field is STM32G431xx.Bit;
   subtype ACR1_SYNCEN_Field is STM32G431xx.UInt2;
   subtype ACR1_MONO_Field is STM32G431xx.Bit;
   subtype ACR1_OutDri_Field is STM32G431xx.Bit;
   subtype ACR1_SAIAEN_Field is STM32G431xx.Bit;
   subtype ACR1_DMAEN_Field is STM32G431xx.Bit;
   subtype ACR1_NODIV_Field is STM32G431xx.Bit;
   subtype ACR1_MCJDIV_Field is STM32G431xx.UInt6;
   subtype ACR1_OSR_Field is STM32G431xx.Bit;
   subtype ACR1_MCKEN_Field is STM32G431xx.Bit;
   ...
   type ACR1_Register is record
      ...
      --  unspecified
      Reserved_4_4   : STM32G431xx.Bit := 16#0#;
      --  Data size
      ...
      --  unspecified
      Reserved_18_18 : STM32G431xx.Bit := 16#0#;
      --  No divider
   ...
   subtype ACR2_FTH_Field is STM32G431xx.UInt3;
   subtype ACR2_FFLUS_Field is STM32G431xx.Bit;
   subtype ACR2_TRIS_Field is STM32G431xx.Bit;
   subtype ACR2_MUTE_Field is STM32G431xx.Bit;
   subtype ACR2_MUTEVAL_Field is STM32G431xx.Bit;
   subtype ACR2_MUTECN_Field is STM32G431xx.UInt6;
   subtype ACR2_CPL_Field is STM32G431xx.Bit;
   subtype ACR2_COMP_Field is STM32G431xx.UInt2;
   ...
   subtype AFRCR_FRL_Field is STM32G431xx.Byte;
   subtype AFRCR_FSALL_Field is STM32G431xx.UInt7;
   subtype AFRCR_FSDEF_Field is STM32G431xx.Bit;
   subtype AFRCR_FSPOL_Field is STM32G431xx.Bit;
   subtype AFRCR_FSOFF_Field is STM32G431xx.Bit;
   ...
   subtype ASLOTR_FBOFF_Field is STM32G431xx.UInt5;
   subtype ASLOTR_SLOTSZ_Field is STM32G431xx.UInt2;
   subtype ASLOTR_NBSLOT_Field is STM32G431xx.UInt4;
   subtype ASLOTR_SLOTEN_Field is STM32G431xx.UInt16;
   ...
   subtype AIM_OVRUDRIE_Field is STM32G431xx.Bit;
   subtype AIM_MUTEDET_Field is STM32G431xx.Bit;
   subtype AIM_WCKCFG_Field is STM32G431xx.Bit;
   subtype AIM_FREQIE_Field is STM32G431xx.Bit;
   subtype AIM_CNRDYIE_Field is STM32G431xx.Bit;
   subtype AIM_AFSDETIE_Field is STM32G431xx.Bit;
   subtype AIM_LFSDET_Field is STM32G431xx.Bit;
   ...
   subtype ASR_OVRUDR_Field is STM32G431xx.Bit;
   subtype ASR_MUTEDET_Field is STM32G431xx.Bit;
   subtype ASR_WCKCFG_Field is STM32G431xx.Bit;
   subtype ASR_FREQ_Field is STM32G431xx.Bit;
   subtype ASR_CNRDY_Field is STM32G431xx.Bit;
   subtype ASR_AFSDET_Field is STM32G431xx.Bit;
   subtype ASR_LFSDET_Field is STM32G431xx.Bit;
   subtype ASR_FLVL_Field is STM32G431xx.UInt3;
   ...
   subtype ACLRFR_OVRUDR_Field is STM32G431xx.Bit;
   subtype ACLRFR_MUTEDET_Field is STM32G431xx.Bit;
   subtype ACLRFR_WCKCFG_Field is STM32G431xx.Bit;
   subtype ACLRFR_CNRDY_Field is STM32G431xx.Bit;
   subtype ACLRFR_CAFSDET_Field is STM32G431xx.Bit;
   subtype ACLRFR_LFSDET_Field is STM32G431xx.Bit;
   ...
   subtype BCR1_MODE_Field is STM32G431xx.UInt2;
   subtype BCR1_PRTCFG_Field is STM32G431xx.UInt2;
   subtype BCR1_DS_Field is STM32G431xx.UInt3;
   subtype BCR1_LSBFIRST_Field is STM32G431xx.Bit;
   subtype BCR1_CKSTR_Field is STM32G431xx.Bit;
   subtype BCR1_SYNCEN_Field is STM32G431xx.UInt2;
   subtype BCR1_MONO_Field is STM32G431xx.Bit;
   subtype BCR1_OutDri_Field is STM32G431xx.Bit;
   subtype BCR1_SAIBEN_Field is STM32G431xx.Bit;
   subtype BCR1_DMAEN_Field is STM32G431xx.Bit;
   subtype BCR1_NODIV_Field is STM32G431xx.Bit;
   subtype BCR1_MCJDIV_Field is STM32G431xx.UInt6;
   subtype BCR1_OSR_Field is STM32G431xx.Bit;
   subtype BCR1_MCKEN_Field is STM32G431xx.Bit;
   ...
   subtype BCR2_FTH_Field is STM32G431xx.UInt3;
   subtype BCR2_FFLUS_Field is STM32G431xx.Bit;
   subtype BCR2_TRIS_Field is STM32G431xx.Bit;
   subtype BCR2_MUTE_Field is STM32G431xx.Bit;
   subtype BCR2_MUTEVAL_Field is STM32G431xx.Bit;
   subtype BCR2_MUTECN_Field is STM32G431xx.UInt6;
   subtype BCR2_CPL_Field is STM32G431xx.Bit;
   subtype BCR2_COMP_Field is STM32G431xx.UInt2;
   ...
   subtype BFRCR_FRL_Field is STM32G431xx.Byte;
   subtype BFRCR_FSALL_Field is STM32G431xx.UInt7;
   subtype BFRCR_FSDEF_Field is STM32G431xx.Bit;
   subtype BFRCR_FSPOL_Field is STM32G431xx.Bit;
   subtype BFRCR_FSOFF_Field is STM32G431xx.Bit;
   ...
   subtype BSLOTR_FBOFF_Field is STM32G431xx.UInt5;
   subtype BSLOTR_SLOTSZ_Field is STM32G431xx.UInt2;
   subtype BSLOTR_NBSLOT_Field is STM32G431xx.UInt4;
   subtype BSLOTR_SLOTEN_Field is STM32G431xx.UInt16;
   ...
   subtype BIM_OVRUDRIE_Field is STM32G431xx.Bit;
   subtype BIM_MUTEDET_Field is STM32G431xx.Bit;
   subtype BIM_WCKCFG_Field is STM32G431xx.Bit;
   subtype BIM_FREQIE_Field is STM32G431xx.Bit;
   subtype BIM_CNRDYIE_Field is STM32G431xx.Bit;
   subtype BIM_AFSDETIE_Field is STM32G431xx.Bit;
   subtype BIM_LFSDETIE_Field is STM32G431xx.Bit;
   ...
   subtype BSR_OVRUDR_Field is STM32G431xx.Bit;
   subtype BSR_MUTEDET_Field is STM32G431xx.Bit;
   subtype BSR_WCKCFG_Field is STM32G431xx.Bit;
   subtype BSR_FREQ_Field is STM32G431xx.Bit;
   subtype BSR_CNRDY_Field is STM32G431xx.Bit;
   subtype BSR_AFSDET_Field is STM32G431xx.Bit;
   subtype BSR_LFSDET_Field is STM32G431xx.Bit;
   subtype BSR_FLVL_Field is STM32G431xx.UInt3;
   ...
   type BSR_Register is record
      ...
      --  unspecified
      Reserved_7_15  : STM32G431xx.UInt9;
      --  Read-only. FIFO level threshold
      FLVL           : BSR_FLVL_Field;
      --  unspecified
      Reserved_19_31 : STM32G431xx.UInt13;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype BCLRFR_OVRUDR_Field is STM32G431xx.Bit;
   subtype BCLRFR_MUTEDET_Field is STM32G431xx.Bit;
   subtype BCLRFR_WCKCFG_Field is STM32G431xx.Bit;
   subtype BCLRFR_CNRDY_Field is STM32G431xx.Bit;
   subtype BCLRFR_CAFSDET_Field is STM32G431xx.Bit;
   subtype BCLRFR_LFSDET_Field is STM32G431xx.Bit;
   ...
   subtype PDMCR_PDMEN_Field is STM32G431xx.Bit;
   subtype PDMCR_MICNBR_Field is STM32G431xx.UInt2;
   --  PDMCR_CKEN array element
   subtype PDMCR_CKEN_Element is STM32G431xx.Bit;
   ...
   type PDMCR_Register is record
      ...
      --  unspecified
      Reserved_1_3   : STM32G431xx.UInt3 := 16#0#;
      --  MICNBR
   ...
   subtype PDMDLY_DLYM1L_Field is STM32G431xx.UInt3;
   subtype PDMDLY_DLYM1R_Field is STM32G431xx.UInt3;
   subtype PDMDLY_DLYM2L_Field is STM32G431xx.UInt3;
   subtype PDMDLY_DLYM2R_Field is STM32G431xx.UInt3;
   subtype PDMDLY_DLYM3L_Field is STM32G431xx.UInt3;
   subtype PDMDLY_DLYM3R_Field is STM32G431xx.UInt3;
   subtype PDMDLY_DLYM4L_Field is STM32G431xx.UInt3;
   subtype PDMDLY_DLYM4R_Field is STM32G431xx.UInt3;
   ...
   type SAI_Peripheral is record
      ...
      --  AData register
      ADR    : aliased STM32G431xx.UInt32;
      --  BConfiguration register 1
      ...
      --  BData register
      BDR    : aliased STM32G431xx.UInt32;
      --  PDM control register
