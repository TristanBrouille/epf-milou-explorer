...
package STM32G431xx.Flash is
   ...
   subtype ACR_LATENCY_Field is STM32G431xx.UInt4;
   subtype ACR_PRFTEN_Field is STM32G431xx.Bit;
   subtype ACR_ICEN_Field is STM32G431xx.Bit;
   subtype ACR_DCEN_Field is STM32G431xx.Bit;
   subtype ACR_ICRST_Field is STM32G431xx.Bit;
   subtype ACR_DCRST_Field is STM32G431xx.Bit;
   subtype ACR_RUN_PD_Field is STM32G431xx.Bit;
   subtype ACR_SLEEP_PD_Field is STM32G431xx.Bit;
   subtype ACR_DBG_SWEN_Field is STM32G431xx.Bit;
   ...
   type ACR_Register is record
      ...
      --  unspecified
      Reserved_15_17 : STM32G431xx.UInt3 := 16#0#;
   ...
   subtype SR_EOP_Field is STM32G431xx.Bit;
   subtype SR_OPERR_Field is STM32G431xx.Bit;
   subtype SR_PROGERR_Field is STM32G431xx.Bit;
   subtype SR_WRPERR_Field is STM32G431xx.Bit;
   subtype SR_PGAERR_Field is STM32G431xx.Bit;
   subtype SR_SIZERR_Field is STM32G431xx.Bit;
   subtype SR_PGSERR_Field is STM32G431xx.Bit;
   subtype SR_MISERR_Field is STM32G431xx.Bit;
   subtype SR_FASTERR_Field is STM32G431xx.Bit;
   subtype SR_RDERR_Field is STM32G431xx.Bit;
   subtype SR_OPTVERR_Field is STM32G431xx.Bit;
   subtype SR_BSY_Field is STM32G431xx.Bit;
   ...
   subtype CR_PG_Field is STM32G431xx.Bit;
   subtype CR_PER_Field is STM32G431xx.Bit;
   subtype CR_MER1_Field is STM32G431xx.Bit;
   subtype CR_PNB_Field is STM32G431xx.UInt7;
   subtype CR_STRT_Field is STM32G431xx.Bit;
   subtype CR_OPTSTRT_Field is STM32G431xx.Bit;
   subtype CR_FSTPG_Field is STM32G431xx.Bit;
   subtype CR_EOPIE_Field is STM32G431xx.Bit;
   subtype CR_ERRIE_Field is STM32G431xx.Bit;
   subtype CR_RDERRIE_Field is STM32G431xx.Bit;
   subtype CR_OBL_LAUNCH_Field is STM32G431xx.Bit;
   subtype CR_SEC_PROT1_Field is STM32G431xx.Bit;
   subtype CR_OPTLOCK_Field is STM32G431xx.Bit;
   subtype CR_LOCK_Field is STM32G431xx.Bit;
   ...
   subtype ECCR_ADDR_ECC_Field is STM32G431xx.UInt19;
   subtype ECCR_BK_ECC_Field is STM32G431xx.Bit;
   subtype ECCR_SYSF_ECC_Field is STM32G431xx.Bit;
   subtype ECCR_ECCIE_Field is STM32G431xx.Bit;
   subtype ECCR_ECCC2_Field is STM32G431xx.Bit;
   subtype ECCR_ECCD2_Field is STM32G431xx.Bit;
   subtype ECCR_ECCC_Field is STM32G431xx.Bit;
   subtype ECCR_ECCD_Field is STM32G431xx.Bit;
   ...
   type ECCR_Register is record
      ...
      --  unspecified
      Reserved_19_20 : STM32G431xx.UInt2 := 16#0#;
      --  Read-only. BK_ECC
      ...
      --  unspecified
      Reserved_25_27 : STM32G431xx.UInt3 := 16#0#;
      --  ECC correction
   ...
   subtype OPTR_RDP_Field is STM32G431xx.Byte;
   subtype OPTR_BOR_LEV_Field is STM32G431xx.UInt3;
   subtype OPTR_nRST_STOP_Field is STM32G431xx.Bit;
   subtype OPTR_nRST_STDBY_Field is STM32G431xx.Bit;
   subtype OPTR_nRST_SHDW_Field is STM32G431xx.Bit;
   subtype OPTR_IDWG_SW_Field is STM32G431xx.Bit;
   subtype OPTR_IWDG_STOP_Field is STM32G431xx.Bit;
   subtype OPTR_IWDG_STDBY_Field is STM32G431xx.Bit;
   subtype OPTR_WWDG_SW_Field is STM32G431xx.Bit;
   subtype OPTR_nBOOT1_Field is STM32G431xx.Bit;
   subtype OPTR_SRAM2_PE_Field is STM32G431xx.Bit;
   subtype OPTR_SRAM2_RST_Field is STM32G431xx.Bit;
   subtype OPTR_nSWBOOT0_Field is STM32G431xx.Bit;
   subtype OPTR_nBOOT0_Field is STM32G431xx.Bit;
   subtype OPTR_NRST_MODE_Field is STM32G431xx.UInt2;
   subtype OPTR_IRHEN_Field is STM32G431xx.Bit;
   ...
   type OPTR_Register is record
      ...
      --  unspecified
      Reserved_20_22 : STM32G431xx.UInt3 := 16#0#;
      --  Boot configuration
      ...
      --  unspecified
      Reserved_31_31 : STM32G431xx.Bit := 16#1#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype PCROP1SR_PCROP1_STRT_Field is STM32G431xx.UInt15;
   ...
   type PCROP1SR_Register is record
      ...
      --  unspecified
      Reserved_15_31 : STM32G431xx.UInt17 := 16#1FFFE#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype PCROP1ER_PCROP1_END_Field is STM32G431xx.UInt15;
   subtype PCROP1ER_PCROP_RDP_Field is STM32G431xx.Bit;
   ...
   type PCROP1ER_Register is record
      ...
      --  unspecified
      Reserved_15_30 : STM32G431xx.UInt16 := 16#1FFE#;
   ...
   subtype WRP1AR_WRP1A_STRT_Field is STM32G431xx.UInt7;
   subtype WRP1AR_WRP1A_END_Field is STM32G431xx.UInt7;
   ...
   subtype WRP1BR_WRP1B_STRT_Field is STM32G431xx.UInt7;
   subtype WRP1BR_WRP1B_END_Field is STM32G431xx.UInt7;
   ...
   subtype SEC1R_SEC_SIZE1_Field is STM32G431xx.Byte;
   subtype SEC1R_BOOT_LOCK_Field is STM32G431xx.Bit;
   ...
   type SEC1R_Register is record
      ...
      --  unspecified
      Reserved_8_15  : STM32G431xx.Byte := 16#FF#;
      --  BOOT_LOCK
      BOOT_LOCK      : SEC1R_BOOT_LOCK_Field := 16#0#;
      --  unspecified
      Reserved_17_31 : STM32G431xx.UInt15 := 16#7F80#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type FLASH_Peripheral is record
      ...
      PDKEYR   : aliased STM32G431xx.UInt32;
      --  Flash key register
      KEYR     : aliased STM32G431xx.UInt32;
      --  Option byte key register
      OPTKEYR  : aliased STM32G431xx.UInt32;
      --  Status register
