...
package STM32G431xx.SPI is
   ...
   subtype CR1_CPHA_Field is STM32G431xx.Bit;
   subtype CR1_CPOL_Field is STM32G431xx.Bit;
   subtype CR1_MSTR_Field is STM32G431xx.Bit;
   subtype CR1_BR_Field is STM32G431xx.UInt3;
   subtype CR1_SPE_Field is STM32G431xx.Bit;
   subtype CR1_LSBFIRST_Field is STM32G431xx.Bit;
   subtype CR1_SSI_Field is STM32G431xx.Bit;
   subtype CR1_SSM_Field is STM32G431xx.Bit;
   subtype CR1_RXONLY_Field is STM32G431xx.Bit;
   subtype CR1_DFF_Field is STM32G431xx.Bit;
   subtype CR1_CRCNEXT_Field is STM32G431xx.Bit;
   subtype CR1_CRCEN_Field is STM32G431xx.Bit;
   subtype CR1_BIDIOE_Field is STM32G431xx.Bit;
   subtype CR1_BIDIMODE_Field is STM32G431xx.Bit;
   ...
   subtype CR2_RXDMAEN_Field is STM32G431xx.Bit;
   subtype CR2_TXDMAEN_Field is STM32G431xx.Bit;
   subtype CR2_SSOE_Field is STM32G431xx.Bit;
   subtype CR2_NSSP_Field is STM32G431xx.Bit;
   subtype CR2_FRF_Field is STM32G431xx.Bit;
   subtype CR2_ERRIE_Field is STM32G431xx.Bit;
   subtype CR2_RXNEIE_Field is STM32G431xx.Bit;
   subtype CR2_TXEIE_Field is STM32G431xx.Bit;
   subtype CR2_DS_Field is STM32G431xx.UInt4;
   subtype CR2_FRXTH_Field is STM32G431xx.Bit;
   subtype CR2_LDMA_RX_Field is STM32G431xx.Bit;
   subtype CR2_LDMA_TX_Field is STM32G431xx.Bit;
   ...
   subtype SR_TXE_Field is STM32G431xx.Bit;
   subtype SR_CRCERR_Field is STM32G431xx.Bit;
   subtype SR_MODF_Field is STM32G431xx.Bit;
   subtype SR_OVR_Field is STM32G431xx.Bit;
   subtype SR_BSY_Field is STM32G431xx.Bit;
   subtype SR_TIFRFE_Field is STM32G431xx.Bit;
   subtype SR_FRLVL_Field is STM32G431xx.UInt2;
   subtype SR_FTLVL_Field is STM32G431xx.UInt2;
   ...
   subtype DR_DR_Field is STM32G431xx.UInt16;
   ...
   subtype CRCPR_CRCPOLY_Field is STM32G431xx.UInt16;
   ...
   subtype RXCRCR_RxCRC_Field is STM32G431xx.UInt16;
   ...
   subtype TXCRCR_TxCRC_Field is STM32G431xx.UInt16;
   ...
   subtype I2SCFGR_CHLEN_Field is STM32G431xx.Bit;
   subtype I2SCFGR_DATLEN_Field is STM32G431xx.UInt2;
   subtype I2SCFGR_CKPOL_Field is STM32G431xx.Bit;
   subtype I2SCFGR_I2SSTD_Field is STM32G431xx.UInt2;
   subtype I2SCFGR_PCMSYNC_Field is STM32G431xx.Bit;
   subtype I2SCFGR_I2SCFG_Field is STM32G431xx.UInt2;
   subtype I2SCFGR_I2SE_Field is STM32G431xx.Bit;
   subtype I2SCFGR_I2SMOD_Field is STM32G431xx.Bit;
   ...
   subtype I2SPR_I2SDIV_Field is STM32G431xx.Byte;
   subtype I2SPR_ODD_Field is STM32G431xx.Bit;
   subtype I2SPR_MCKOE_Field is STM32G431xx.Bit;
