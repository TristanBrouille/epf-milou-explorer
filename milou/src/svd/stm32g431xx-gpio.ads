...
package STM32G431xx.GPIO is
   ...
   --  MODER array element
   subtype MODER_Element is STM32G431xx.UInt2;
   ...
   subtype OTYPER_OT_Element is STM32G431xx.Bit;
   ...
   subtype OSPEEDR_Element is STM32G431xx.UInt2;
   ...
   --  PUPDR array element
   subtype PUPDR_Element is STM32G431xx.UInt2;
   ...
   --  IDR array element
   subtype IDR_Element is STM32G431xx.Bit;
   ...
   --  ODR array element
   subtype ODR_Element is STM32G431xx.Bit;
   ...
   subtype BSRR_BS_Element is STM32G431xx.Bit;
   ...
   subtype BSRR_BR_Element is STM32G431xx.Bit;
   ...
   subtype LCKR_LCK_Element is STM32G431xx.Bit;
   ...
   subtype LCKR_LCKK_Field is STM32G431xx.Bit;
   ...
   --  AFRL array element
   subtype AFRL_Element is STM32G431xx.UInt4;
   ...
   --  AFRH array element
   subtype AFRH_Element is STM32G431xx.UInt4;
   ...
   subtype BRR_BR_Element is STM32G431xx.Bit;
