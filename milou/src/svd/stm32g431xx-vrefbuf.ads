...
package STM32G431xx.VREFBUF is
   pragma Preelaborate;
   ...
   subtype VREFBUF_CSR_ENVR_Field is STM32G431xx.Bit;
   subtype VREFBUF_CSR_HIZ_Field is STM32G431xx.Bit;
   subtype VREFBUF_CSR_VRR_Field is STM32G431xx.Bit;
   subtype VREFBUF_CSR_VRS_Field is STM32G431xx.UInt2;
   ...
   subtype VREFBUF_CCR_TRIM_Field is STM32G431xx.UInt6;
