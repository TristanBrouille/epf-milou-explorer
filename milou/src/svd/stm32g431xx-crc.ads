...
package STM32G431xx.CRC is
   ...
   subtype CR_POLYSIZE_Field is STM32G431xx.UInt2;
   subtype CR_REV_IN_Field is STM32G431xx.UInt2;
   subtype CR_REV_OUT_Field is STM32G431xx.Bit;
   ...
   type CRC_Peripheral is record
      ...
      IDR  : aliased STM32G431xx.UInt32;
      --  Control register
      CR   : aliased CR_Register;
      --  Initial CRC value
      INIT : aliased STM32G431xx.UInt32;
      --  polynomial
      POL  : aliased STM32G431xx.UInt32;
   end record
     with Volatile;
