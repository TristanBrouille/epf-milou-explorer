...
package STM32G431xx.USART is
   ...
   subtype CR1_UE_Field is STM32G431xx.Bit;
   subtype CR1_UESM_Field is STM32G431xx.Bit;
   subtype CR1_RE_Field is STM32G431xx.Bit;
   subtype CR1_TE_Field is STM32G431xx.Bit;
   subtype CR1_IDLEIE_Field is STM32G431xx.Bit;
   subtype CR1_RXNEIE_Field is STM32G431xx.Bit;
   subtype CR1_TCIE_Field is STM32G431xx.Bit;
   subtype CR1_TXEIE_Field is STM32G431xx.Bit;
   subtype CR1_PEIE_Field is STM32G431xx.Bit;
   subtype CR1_PS_Field is STM32G431xx.Bit;
   subtype CR1_PCE_Field is STM32G431xx.Bit;
   subtype CR1_WAKE_Field is STM32G431xx.Bit;
   subtype CR1_M0_Field is STM32G431xx.Bit;
   subtype CR1_MME_Field is STM32G431xx.Bit;
   subtype CR1_CMIE_Field is STM32G431xx.Bit;
   --  CR1_DEDT array element
   subtype CR1_DEDT_Element is STM32G431xx.Bit;
   ...
   subtype CR1_DEAT_Element is STM32G431xx.Bit;
   ...
   subtype CR1_M1_Field is STM32G431xx.Bit;
   subtype CR1_FIFOEN_Field is STM32G431xx.Bit;
   subtype CR1_TXFEIE_Field is STM32G431xx.Bit;
   subtype CR1_RXFFIE_Field is STM32G431xx.Bit;
   ...
   subtype CR2_ADDM7_Field is STM32G431xx.Bit;
   subtype CR2_STOP_Field is STM32G431xx.UInt2;
   subtype CR2_SWAP_Field is STM32G431xx.Bit;
   subtype CR2_RXINV_Field is STM32G431xx.Bit;
   subtype CR2_TXINV_Field is STM32G431xx.Bit;
   subtype CR2_TAINV_Field is STM32G431xx.Bit;
   subtype CR2_MSBFIRST_Field is STM32G431xx.Bit;
   subtype CR2_ADD0_3_Field is STM32G431xx.UInt4;
   subtype CR2_ADD4_7_Field is STM32G431xx.UInt4;
   ...
   type CR2_Register is record
      ...
      --  unspecified
      Reserved_5_11  : STM32G431xx.UInt7 := 16#0#;
      --  STOP bits
   ...
   subtype CR3_EIE_Field is STM32G431xx.Bit;
   subtype CR3_HDSEL_Field is STM32G431xx.Bit;
   subtype CR3_DMAR_Field is STM32G431xx.Bit;
   subtype CR3_DMAT_Field is STM32G431xx.Bit;
   subtype CR3_RTSE_Field is STM32G431xx.Bit;
   subtype CR3_CTSE_Field is STM32G431xx.Bit;
   subtype CR3_CTSIE_Field is STM32G431xx.Bit;
   subtype CR3_OVRDIS_Field is STM32G431xx.Bit;
   subtype CR3_DDRE_Field is STM32G431xx.Bit;
   subtype CR3_DEM_Field is STM32G431xx.Bit;
   subtype CR3_DEP_Field is STM32G431xx.Bit;
   subtype CR3_WUS_Field is STM32G431xx.UInt2;
   subtype CR3_WUFIE_Field is STM32G431xx.Bit;
   subtype CR3_TXFTIE_Field is STM32G431xx.Bit;
   subtype CR3_RXFTCFG_Field is STM32G431xx.UInt3;
   subtype CR3_RXFTIE_Field is STM32G431xx.Bit;
   subtype CR3_TXFTCFG_Field is STM32G431xx.UInt3;
   ...
   type CR3_Register is record
      ...
      --  unspecified
      Reserved_1_2   : STM32G431xx.UInt2 := 16#0#;
      ...
      --  unspecified
      Reserved_16_19 : STM32G431xx.UInt4 := 16#0#;
   ...
   subtype BRR_BRR_Field is STM32G431xx.UInt20;
   ...
   subtype RQR_SBKRQ_Field is STM32G431xx.Bit;
   subtype RQR_MMRQ_Field is STM32G431xx.Bit;
   subtype RQR_RXFRQ_Field is STM32G431xx.Bit;
   subtype RQR_TXFRQ_Field is STM32G431xx.Bit;

   --  Request register
   type RQR_Register is record
      --  unspecified
      Reserved_0_0  : STM32G431xx.Bit := 16#0#;
   ...
   subtype ISR_PE_Field is STM32G431xx.Bit;
   subtype ISR_FE_Field is STM32G431xx.Bit;
   subtype ISR_NF_Field is STM32G431xx.Bit;
   subtype ISR_ORE_Field is STM32G431xx.Bit;
   subtype ISR_IDLE_Field is STM32G431xx.Bit;
   subtype ISR_RXNE_Field is STM32G431xx.Bit;
   subtype ISR_TC_Field is STM32G431xx.Bit;
   subtype ISR_TXE_Field is STM32G431xx.Bit;
   subtype ISR_CTSIF_Field is STM32G431xx.Bit;
   subtype ISR_CTS_Field is STM32G431xx.Bit;
   subtype ISR_BUSY_Field is STM32G431xx.Bit;
   subtype ISR_CMF_Field is STM32G431xx.Bit;
   subtype ISR_SBKF_Field is STM32G431xx.Bit;
   subtype ISR_RWU_Field is STM32G431xx.Bit;
   subtype ISR_WUF_Field is STM32G431xx.Bit;
   subtype ISR_TEACK_Field is STM32G431xx.Bit;
   subtype ISR_REACK_Field is STM32G431xx.Bit;
   subtype ISR_TXFE_Field is STM32G431xx.Bit;
   subtype ISR_RXFF_Field is STM32G431xx.Bit;
   subtype ISR_RXFT_Field is STM32G431xx.Bit;
   subtype ISR_TXFT_Field is STM32G431xx.Bit;
   ...
   type ISR_Register is record
      ...
      RXFF           : ISR_RXFF_Field;
      --  unspecified
      Reserved_25_25 : STM32G431xx.Bit;
      --  Read-only. RXFT
      RXFT           : ISR_RXFT_Field;
      --  Read-only. TXFT
      TXFT           : ISR_TXFT_Field;
      --  unspecified
      Reserved_28_31 : STM32G431xx.UInt4;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype ICR_PECF_Field is STM32G431xx.Bit;
   subtype ICR_FECF_Field is STM32G431xx.Bit;
   subtype ICR_NCF_Field is STM32G431xx.Bit;
   subtype ICR_ORECF_Field is STM32G431xx.Bit;
   subtype ICR_IDLECF_Field is STM32G431xx.Bit;
   subtype ICR_TCCF_Field is STM32G431xx.Bit;
   subtype ICR_CTSCF_Field is STM32G431xx.Bit;
   subtype ICR_CMCF_Field is STM32G431xx.Bit;
   subtype ICR_WUCF_Field is STM32G431xx.Bit;
   ...
   type ICR_Register is record
      ...
      --  unspecified
      Reserved_10_16 : STM32G431xx.UInt7 := 16#0#;
      ...
      --  unspecified
      Reserved_21_31 : STM32G431xx.UInt11 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype RDR_RDR_Field is STM32G431xx.UInt9;
   ...
   type RDR_Register is record
      ...
      RDR           : RDR_RDR_Field;
      --  unspecified
      Reserved_9_31 : STM32G431xx.UInt23;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype TDR_TDR_Field is STM32G431xx.UInt9;
   ...
   subtype PRESC_PRESCALER_Field is STM32G431xx.UInt4;
   ...
   subtype CR1_OVER8_Field is STM32G431xx.Bit;
   subtype CR1_RTOIE_Field is STM32G431xx.Bit;
   subtype CR1_EOBIE_Field is STM32G431xx.Bit;
   ...
   subtype CR2_SLVEN_Field is STM32G431xx.Bit;
   subtype CR2_DIS_NSS_Field is STM32G431xx.Bit;
   subtype CR2_LBDL_Field is STM32G431xx.Bit;
   subtype CR2_LBDIE_Field is STM32G431xx.Bit;
   subtype CR2_LBCL_Field is STM32G431xx.Bit;
   subtype CR2_CPHA_Field is STM32G431xx.Bit;
   subtype CR2_CPOL_Field is STM32G431xx.Bit;
   subtype CR2_CLKEN_Field is STM32G431xx.Bit;
   subtype CR2_LINEN_Field is STM32G431xx.Bit;
   subtype CR2_ABREN_Field is STM32G431xx.Bit;
   --  CR2_ABRMOD array element
   subtype CR2_ABRMOD_Element is STM32G431xx.Bit;
   ...
   subtype CR2_RTOEN_Field is STM32G431xx.Bit;
   ...
   subtype CR3_IREN_Field is STM32G431xx.Bit;
   subtype CR3_IRLP_Field is STM32G431xx.Bit;
   subtype CR3_NACK_Field is STM32G431xx.Bit;
   subtype CR3_SCEN_Field is STM32G431xx.Bit;
   subtype CR3_ONEBIT_Field is STM32G431xx.Bit;
   subtype CR3_SCARCNT_Field is STM32G431xx.UInt3;
   subtype CR3_TCBGTIE_Field is STM32G431xx.Bit;
   ...
   subtype BRR_DIV_Fraction_Field is STM32G431xx.UInt4;
   subtype BRR_DIV_Mantissa_Field is STM32G431xx.UInt12;
   ...
   subtype GTPR_PSC_Field is STM32G431xx.Byte;
   subtype GTPR_GT_Field is STM32G431xx.Byte;
   ...
   subtype RTOR_RTO_Field is STM32G431xx.UInt24;
   subtype RTOR_BLEN_Field is STM32G431xx.Byte;
   ...
   subtype RQR_ABRRQ_Field is STM32G431xx.Bit;
   ...
   subtype ISR_LBDF_Field is STM32G431xx.Bit;
   subtype ISR_RTOF_Field is STM32G431xx.Bit;
   subtype ISR_EOBF_Field is STM32G431xx.Bit;
   subtype ISR_UDR_Field is STM32G431xx.Bit;
   subtype ISR_ABRE_Field is STM32G431xx.Bit;
   subtype ISR_ABRF_Field is STM32G431xx.Bit;
   subtype ISR_TCBGT_Field is STM32G431xx.Bit;
   ...
   subtype ICR_TXFECF_Field is STM32G431xx.Bit;
   subtype ICR_TCBGTCF_Field is STM32G431xx.Bit;
   subtype ICR_LBDCF_Field is STM32G431xx.Bit;
   subtype ICR_RTOCF_Field is STM32G431xx.Bit;
   subtype ICR_EOBCF_Field is STM32G431xx.Bit;
   subtype ICR_UDRCF_Field is STM32G431xx.Bit;
   ...
   type ICR_Register_1 is record
      ...
      --  unspecified
      Reserved_14_16 : STM32G431xx.UInt3 := 16#0#;
      --  Write-only. Character match clear flag
      CMCF           : ICR_CMCF_Field := 16#0#;
      --  unspecified
      Reserved_18_19 : STM32G431xx.UInt2 := 16#0#;
