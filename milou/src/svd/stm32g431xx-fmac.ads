...
package STM32G431xx.FMAC is
   ...
   subtype X1BUFCFG_X1_BASE_Field is STM32G431xx.Byte;
   subtype X1BUFCFG_X1_BUF_SIZE_Field is STM32G431xx.Byte;
   subtype X1BUFCFG_FULL_WM_Field is STM32G431xx.UInt2;
   ...
   type X1BUFCFG_Register is record
      ...
      --  unspecified
      Reserved_16_23 : STM32G431xx.Byte := 16#0#;
      --  FULL_WM
   ...
   subtype X2BUFCFG_X2_BASE_Field is STM32G431xx.Byte;
   subtype X2BUFCFG_X2_BUF_SIZE_Field is STM32G431xx.Byte;
   ...
   subtype YBUFCFG_Y_BASE_Field is STM32G431xx.Byte;
   subtype YBUFCFG_Y_BUF_SIZE_Field is STM32G431xx.Byte;
   subtype YBUFCFG_EMPTY_WM_Field is STM32G431xx.UInt2;
   ...
   subtype PARAM_P_Field is STM32G431xx.Byte;
   subtype PARAM_Q_Field is STM32G431xx.Byte;
   subtype PARAM_R_Field is STM32G431xx.Byte;
   subtype PARAM_FUNC_Field is STM32G431xx.UInt7;
   subtype PARAM_START_Field is STM32G431xx.Bit;
   ...
   subtype CR_RIEN_Field is STM32G431xx.Bit;
   subtype CR_WIEN_Field is STM32G431xx.Bit;
   subtype CR_OVFLIEN_Field is STM32G431xx.Bit;
   subtype CR_UNFLIEN_Field is STM32G431xx.Bit;
   subtype CR_SATIEN_Field is STM32G431xx.Bit;
   subtype CR_DMAREN_Field is STM32G431xx.Bit;
   subtype CR_DMAWEN_Field is STM32G431xx.Bit;
   subtype CR_CLIPEN_Field is STM32G431xx.Bit;
   subtype CR_RESET_Field is STM32G431xx.Bit;
   ...
   subtype SR_YEMPTY_Field is STM32G431xx.Bit;
   subtype SR_X1FULL_Field is STM32G431xx.Bit;
   subtype SR_OVFL_Field is STM32G431xx.Bit;
   subtype SR_UNFL_Field is STM32G431xx.Bit;
   subtype SR_SAT_Field is STM32G431xx.Bit;
   ...
   type SR_Register is record
      ...
      --  unspecified
      Reserved_2_7   : STM32G431xx.UInt6;
      --  Read-only. OVFL
      OVFL           : SR_OVFL_Field;
      --  Read-only. UNFL
      UNFL           : SR_UNFL_Field;
   ...
   subtype WDATA_WDATA_Field is STM32G431xx.UInt16;
   ...
   subtype RDATA_RDATA_Field is STM32G431xx.UInt16;
