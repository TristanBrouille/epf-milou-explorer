...
package STM32G431xx.PWR is
   ...
   subtype CR1_LPMS_Field is STM32G431xx.UInt3;
   subtype CR1_DBP_Field is STM32G431xx.Bit;
   subtype CR1_VOS_Field is STM32G431xx.UInt2;
   subtype CR1_LPR_Field is STM32G431xx.Bit;
   ...
   type CR1_Register is record
      ...
      --  unspecified
      Reserved_11_13 : STM32G431xx.UInt3 := 16#0#;
      --  Low-power run
   ...
   subtype CR2_PVDE_Field is STM32G431xx.Bit;
   subtype CR2_PLS_Field is STM32G431xx.UInt3;
   --  CR2_PVMEN array element
   subtype CR2_PVMEN_Element is STM32G431xx.Bit;
   ...
   subtype CR3_EWUP_Element is STM32G431xx.Bit;
   ...
   subtype CR3_RRS_Field is STM32G431xx.Bit;
   subtype CR3_APC_Field is STM32G431xx.Bit;
   subtype CR3_UCPD1_STDBY_Field is STM32G431xx.Bit;
   subtype CR3_UCPD1_DBDIS_Field is STM32G431xx.Bit;
   subtype CR3_EIWUL_Field is STM32G431xx.Bit;
   ...
   subtype CR4_WP_Element is STM32G431xx.Bit;
   ...
   subtype CR4_VBE_Field is STM32G431xx.Bit;
   subtype CR4_VBRS_Field is STM32G431xx.Bit;
   ...
   subtype SR1_WUF_Element is STM32G431xx.Bit;
   ...
   subtype SR1_SBF_Field is STM32G431xx.Bit;
   subtype SR1_WUFI_Field is STM32G431xx.Bit;
   ...
   type SR1_Register is record
      ...
      WUF            : SR1_WUF_Field;
      --  unspecified
      Reserved_5_7   : STM32G431xx.UInt3;
      --  Read-only. Standby flag
      SBF            : SR1_SBF_Field;
      --  unspecified
      Reserved_9_14  : STM32G431xx.UInt6;
   ...
   subtype SR2_REGLPS_Field is STM32G431xx.Bit;
   subtype SR2_REGLPF_Field is STM32G431xx.Bit;
   subtype SR2_VOSF_Field is STM32G431xx.Bit;
   subtype SR2_PVDO_Field is STM32G431xx.Bit;
   --  SR2_PVMO array element
   subtype SR2_PVMO_Element is STM32G431xx.Bit;
   ...
   subtype SCR_CWUF_Element is STM32G431xx.Bit;
   ...
   subtype SCR_CSBF_Field is STM32G431xx.Bit;
   ...
   subtype PUCRA_PU_Element is STM32G431xx.Bit;
   ...
   subtype PUCRA_PU15_Field is STM32G431xx.Bit;
   ...
   subtype PDCRA_PD_Element is STM32G431xx.Bit;
   ...
   subtype PDCRA_PD14_Field is STM32G431xx.Bit;
   ...
   subtype PUCRB_PU_Element is STM32G431xx.Bit;
   ...
   subtype PDCRB_PD_Element is STM32G431xx.Bit;
   ...
   subtype PUCRC_PU_Element is STM32G431xx.Bit;
   ...
   subtype PDCRC_PD_Element is STM32G431xx.Bit;
   ...
   subtype PUCRD_PU_Element is STM32G431xx.Bit;
   ...
   subtype PDCRD_PD_Element is STM32G431xx.Bit;
   ...
   subtype PUCRE_PU_Element is STM32G431xx.Bit;
   ...
   subtype PDCRE_PD_Element is STM32G431xx.Bit;
   ...
   subtype PUCRF_PU_Element is STM32G431xx.Bit;
   ...
   subtype PDCRF_PD_Element is STM32G431xx.Bit;
   ...
   subtype PUCRG_PU_Element is STM32G431xx.Bit;
   ...
   subtype PDCRG_PD_Element is STM32G431xx.Bit;
   ...
   subtype CR5_R1MODE_Field is STM32G431xx.Bit;
   ...
   type CR5_Register is record
      ...
      --  unspecified
      Reserved_1_31 : STM32G431xx.UInt31 := 16#80#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
