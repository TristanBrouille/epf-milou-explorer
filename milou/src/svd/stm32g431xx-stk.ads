...
package STM32G431xx.STK is
   ...
   subtype CTRL_TICKINT_Field is STM32G431xx.Bit;
   subtype CTRL_CLKSOURCE_Field is STM32G431xx.Bit;
   subtype CTRL_COUNTFLAG_Field is STM32G431xx.Bit;
   ...
   subtype LOAD_RELOAD_Field is STM32G431xx.UInt24;
   ...
   subtype VAL_CURRENT_Field is STM32G431xx.UInt24;
   ...
   subtype CALIB_TENMS_Field is STM32G431xx.UInt24;
   subtype CALIB_SKEW_Field is STM32G431xx.Bit;
   subtype CALIB_NOREF_Field is STM32G431xx.Bit;
